    ...
    <div className="container mt-4">
      ...
      <div className="responBx">
        ...
        <p>Travelocare Online Limited, including all legal entities under the Travelocare group
          ...
          (hereafter referred as &quot;information&quot; or &quot;personal information&quot; or &quot;personal data&quot; or
          &quot;special category of personal data&quot;) by handling it responsibly and safeguarding it using appropriate
          technical and organizational measures.</p>
        <p>We want to assure you that we follow appropriate standards when it comes to protecting your privacy on our Sales
          Channel.
...
While we take data security seriously and partner with reputable providers, we cannot be held liable for any data theft or security breaches that may occur at the data center hosting our website.</p>
        ...
        <ul className="ml-4">
          ...
          <li>To obtain any legally-required consent, for the collection, use, disclosure, and transfer (including cross-border
            transfer) of individual&apos;s personal information, from the individual in accordance with the legal and regulatory
            requirements
          </li>
        </ul>
        ...
        <p>If you choose not to provide, or object to us processing the information we collect, we may not be able
          ...
          information of other customers/users/travelers</p>
        <p>If you provide personal information to us regarding individuals other than yourself, you agree</p>
        <ul className="ml-4">
          <li>To inform the individual about the content of this privacy policy</li>
          <li>To obtain any legally-required consent, for the collection, use, disclosure, and transfer
            (including cross-border transfer) of individual&apos;s personal information, from the individual in
